  ...
  if (e.code === 'Enter' && value) {
    ...
    function getSum(total, num) {
     ...
     function addCalories(item) {
        document.getElementById("calories").innerHTML = nutrition.caloriesArr.reduce(getSum) + "/" + suggesstedCalories;
    }
...
function completeItem() {
  ...
  addCalories();
  circle.animate(nutrition.caloriesArr.reduce(getSum)/suggesstedCalories.toFixed(0));
  parent.removeChild(item);
